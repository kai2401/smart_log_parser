...
class TestCLI(unittest.TestCase):
    ...
    def test_02_stats_and_query(self):
        ...
        db.insert_entries([
            db.LogEntry(
                id="test-1", timestamp="2026-01-01T10:00:00", tool_id="TEST-01",
                log_type="test", severity="ERROR", raw_message="Test error",
                drain_cluster_id=0, metadata="{}", source_format="test",
                source_filename="test.log", ai_summary="", ai_classification="", ai_root_cause_hint=""
            )
        ])
    ...
    def test_03_export(self):
        ...
        db.insert_entries([
            db.LogEntry(
                id="test-2", timestamp="2026-01-01T10:00:00", tool_id="TEST-02",
                log_type="test", severity="INFO", raw_message="Test info",
                drain_cluster_id=0, metadata="{}", source_format="test",
                source_filename="test.log", ai_summary="", ai_classification="", ai_root_cause_hint=""
            )
        ])
    ...
    def test_04_clear(self):
        ...
        db.insert_entries([
            db.LogEntry(
                id="test-3", timestamp="2026-01-01T10:00:00", tool_id="TEST-03",
                log_type="test", severity="INFO", raw_message="Test clear",
                drain_cluster_id=0, metadata="{}", source_format="test",
                source_filename="test.log", ai_summary="", ai_classification="", ai_root_cause_hint=""
            )
        ])
